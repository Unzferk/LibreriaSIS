...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 card-container">
		<a href="<?= URL::to('admin/productos/create'); ?>">
			<img class="rounded float-left" src="{{ asset('img/producto.png') }}" 
	...
	<div class="col-xs-12 col-sm-6 col-md-3 card-container">
		<a href="<?= URL::to('admin/proveedores/create'); ?>">
			<img class="card-img-top" src="{{ asset('img/proveedor.png') }}" 
	...
	<div class="col-xs-12 col-sm-6 col-md-3 card-container">
		<a href="<?= URL::to('admin/categorias/create'); ?>">
			<img class="card-img-top" src="{{ asset('img/categoria.png') }}" 
			alt="Card image cap" class="img-responsive" style="width: 11rem; 
    ...
    <div class="col-xs-12 col-sm-6 col-md-3 card-container">
		<a href="<?= URL::to('admin/secciones/create'); ?>">
			<img class="card-img-top" src="{{ asset('img/secciones.png') }}" 
			alt="Card image cap" class="img-responsive" style="width: 11rem; 
	...
	<div class="col-xs-12 col-sm-6 col-md-3 card-container">
		<a href="/inicio">
			<img class="card-img-top" src="{{ asset('img/producto2.png') }}" 
			alt="Card image cap" class="img-responsive" style="width: 11rem; 
			padding-left: 0%; margin-top: 10px; margin-left: 0%;">
		</a>
	</div>
	<div class="col-xs-12 col-sm-6 col-md-3 card-container"> 
		<a href="/inicio">
			<img class="rounded float-left" src="{{ asset('img/seccion.png') }}" 
			alt="Card image cap" class="img-responsive" style="width: 11rem; 
			padding-left: 0%; margin-top: 10px; margin-left: 0%;">
		</a>
	</div>
